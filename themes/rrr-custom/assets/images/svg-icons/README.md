...
[`rrr_get_svg( $args = array() ); // Return SVG markup`](../../blob/master/inc/template-tags.php#L125)
```
/**
 * Return SVG markup.
 *
...
Example usage:
`<?php echo rrr_get_svg( array( 'icon' => 'twitter' ) ); ?>`
...
```
[`rrr_do_svg( array( 'icon' => $icon_name ) ); // Echo SVG markup`](../blob/master/inc/template-tags.php#L139)

Example usage:
`<?php rrr_do_svg( array( 'icon' => 'facebook' ) ); ?>`
